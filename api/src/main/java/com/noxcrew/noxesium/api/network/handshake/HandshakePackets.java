...
public class HandshakePackets {
    ...
    public static final NoxesiumPayloadType<ClientboundRegistryUpdatePacket> CLIENTBOUND_REGISTRY_UPDATE =
            client(INSTANCE, "clientbound_registry_update", ClientboundRegistryUpdatePacket.class);
