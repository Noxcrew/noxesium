...
/**
 * An entrypoint for Noxesium, can be defined in `fabric.mod.json` under `noxesium`. This allows
 * additional features to be registered to Noxesium's dynamic registries.
 * <p>
