...
public class CommonEntityComponentTypes {
    ...
    public static NoxesiumComponentType<Unit> DISABLE_BUBBLES =
            register("disable_bubbles", Unit.CODEC, Unit.STREAM_CODEC); // default: not present

    /**
     * Defines a color to use for a beam created by this entity. Applies to guardian beams
     * and end crystal beams.
     */
    public static NoxesiumComponentType<Color> BEAM_COLOR = register(
            "beam_color", NoxesiumExtraCodecs.COLOR_ARGB, NoxesiumExtraStreamCodecs.COLOR_ARGB); // default: not present

    /**
     * Defines a color used in combination with [BEAM_COLOR] to create a linear fade.
     */
    public static NoxesiumComponentType<Color> BEAM_COLOR_FADE = register(
            "beam_color_fade",
            NoxesiumExtraCodecs.COLOR_ARGB,
            NoxesiumExtraStreamCodecs.COLOR_ARGB); // default: not present
    ...
    public static NoxesiumComponentType<String> QIB_BEHAVIOR =
            register("qib_behavior", Codec.STRING, ByteBufCodecs.STRING_UTF8); // default: not present

    /**
     * Defines a color to use for the glowing outline of this entity.
     */
    public static NoxesiumComponentType<Color> GLOW_COLOR = register(
            "glow_color", NoxesiumExtraCodecs.COLOR_ARGB, NoxesiumExtraStreamCodecs.COLOR_ARGB); // default: not present
