...
public record HoverSoundTag(Optional<Sound> hoverOn, Optional<Sound> hoverOff, Boolean onlyPlayInNonPlayerInventories) {
    ...
    public static Codec<HoverSoundTag> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
                    ...
                    Codec.BOOL
                            ...
                            .forGetter(HoverSoundTag::onlyPlayInNonPlayerInventories))
