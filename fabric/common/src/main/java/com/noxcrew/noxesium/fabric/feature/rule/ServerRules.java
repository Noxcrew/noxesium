...
public class ServerRules {
     ...
     */
    public static ClientServerRule<Boolean> CAMERA_LOCKED =
            register(new CameraLockedRule(ServerRuleIndices.CAMERA_LOCKED));

    /**
     * When enabled vanilla background music is fully disabled.
     */
    public static ClientServerRule<Boolean> DISABLE_VANILLA_MUSIC =
            register(new EnableMusicRule(ServerRuleIndices.DISABLE_VANILLA_MUSIC));
     ...
     */
    public static ClientServerRule<Boolean> DISABLE_BOAT_COLLISIONS =
            register(new BooleanServerRule(ServerRuleIndices.DISABLE_BOAT_COLLISIONS, false));

    /**
     * Allows overriding the item that is used when resolving the capabilities of an empty item slot.
     */
    public static ClientServerRule<ItemStack> HAND_ITEM_OVERRIDE =
            register(new ItemStackServerRule(ServerRuleIndices.HAND_ITEM_OVERRIDE));

    /**
     * Moves the handheld map to be shown in the top left/right corner instead of
     * in the regular hand slot.
     */
    public static ClientServerRule<Boolean> SHOW_MAP_IN_UI =
            register(new BooleanServerRule(ServerRuleIndices.SHOW_MAP_IN_UI, false));
     ...
     */
    public static ClientServerRule<Boolean> DISABLE_DEFERRED_CHUNK_UPDATES =
            register(new BooleanServerRule(ServerRuleIndices.DISABLE_DEFERRED_CHUNK_UPDATES, false));

    /**
     * Defines a list of items to show in a custom creative tab.
     */
    public static ItemStackListServerRule CUSTOM_CREATIVE_ITEMS =
            register(new ItemStackListServerRule(ServerRuleIndices.CUSTOM_CREATIVE_ITEMS));
     ...
     */
    public static QibBehaviorServerRule QIB_BEHAVIORS =
    ...
    public static ClientServerRule<Boolean> ENABLE_SMOOTHER_CLIENT_TRIDENT =
            register(new BooleanServerRule(ServerRuleIndices.ENABLE_SMOOTHER_CLIENT_TRIDENT, false));

    /**
     * Disables the map showing as a UI element. Can be used to hide it during loading screens.
     */
    public static ClientServerRule<Boolean> DISABLE_MAP_UI =
            register(new BooleanServerRule(ServerRuleIndices.DISABLE_MAP_UI, false));
    ...
    private static <T extends ClientServerRule<?>> T register(T rule) {
        NoxesiumMod.getInstance().getFeature(ServerRuleModule.class).register(rule.getIndex(), rule);
        return rule;
    }
}
