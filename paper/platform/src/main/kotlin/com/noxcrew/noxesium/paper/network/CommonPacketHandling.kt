...
public class CommonPacketHandling : NoxesiumFeature() {
    init {
        ...
        CommonPackets.SERVER_CLIENT_SETTINGS.addListener(this, ServerboundClientSettingsPacket::class.java) { reference, packet, playerId ->
        ...
        CommonPackets.SERVER_CLIENT_SETTINGS.addListener(this, ServerboundClientSettingsPacketV2::class.java) {
            reference,
            packet,
            playerId
            ->
