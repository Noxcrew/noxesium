 ...
 * possible.
 */
private fun <T> PersistentDataContainer.getNoxesiumComponent(type: NoxesiumComponentType<T>): T? {
...
/** Returns whether this holder has the given component set. */
private fun PersistentDataContainer.hasNoxesiumComponent(type: NoxesiumComponentType<*>): Boolean {
    val craft = this as CraftPersistentDataContainer
...
/** Sets the given component on this holder. */
private fun <T> PersistentDataContainer.setNoxesiumComponent(type: NoxesiumComponentType<T>, value: T?): Boolean {
