package com.noxcrew.noxesium.legacy.paper.api.rule

import com.noxcrew.noxesium.legacy.paper.EntityRuleIndices
import com.noxcrew.noxesium.legacy.paper.api.NoxesiumManager
import com.noxcrew.noxesium.legacy.paper.api.RuleFunction
...
public class EntityRules(
     ...
     */
    public val customGlowColor: RuleFunction<Optional<Color>> = register(EntityRuleIndices.CUSTOM_GLOW_COLOR, 17, ::ColorServerRule)
